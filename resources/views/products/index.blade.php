              ...
              @foreach($products as $index => $product)
                  <tr>
                      ...
                      <td>
                          ...
                          <img src="{{ asset('storage/products/' . $product->gambar_product) }}" alt="Gambar Produk" style="max-width: 100px; max-height: 100px;">
                          @else
                              <p>Tidak ada gambar</p>
                          @endif
                      </td>
                      <td>
                        <a href="{{ url('/edit/' . $product->id)}}" class="btn btn-info btn-sm">Ubah</a>
                        <a href="{{ url('/destroy/' . $product->id)}}" class="btn btn-danger btn-sm">Hapus</a>
                      </td>
                  </tr>
              @endforeach

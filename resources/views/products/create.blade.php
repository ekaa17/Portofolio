            ...
            <form action="{{ url('/store')}}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="harga_product" class="form-control"placeholder="Harga Product">
                  </div>
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Jenis Product</label>
                    <input type="text" name="jenis_product" class="form-control"placeholder="Jenis Product">
                  </div>

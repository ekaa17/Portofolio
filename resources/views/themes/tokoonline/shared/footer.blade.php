<footer>
    <div class="container pt-5">
      <div class="row row-content">
        <div class="col-md-6">
          <h1 class="logo-brand">Kazz <span>Store</span></h1>
        ...
        <div class="col-md-3 mt-4 mt-sm-0">
          ...
          <a href="#">ekapratama.com</a>
          <p>Cilegon Banten</p>
        </div>
      </div>
      <div class="row row-copy mt-4 mt-sm-0">
        <div class="col-md-6">
          <p>&copy; 2024 MSIB. All rights reserved.</p>
        </div>
        <div class="col-md-6 text-sm-end">
          <a href="https://www.instagram.com/heerbeee/"><i class='bx bxl-instagram-alt' ></i></a>
        </div>
      </div>
    </div>
  </footer>